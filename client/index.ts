...
// shaders
const vertex_shader = ctx.createShader(ctx.VERTEX_SHADER) as WebGLShader;
const fragment_shader = ctx.createShader(ctx.FRAGMENT_SHADER) as WebGLShader;
...
// buffers
const vbo = ctx.createBuffer() as WebGLBuffer;
